 ...
 */
export const getCalendarSummary = async (params?: GetCalendarSummaryParams, options?: Parameters<typeof customFetch>[1]): Promise<CalendarSummary> => {

  return customFetch<CalendarSummary>(getGetCalendarSummaryUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getGetCalendarSummaryQueryOptions = <TData = Awaited<ReturnType<typeof getCalendarSummary>>, TError = ErrorType<ErrorResponse>>(params?: GetCalendarSummaryParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCalendarSummary>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetCalendarSummaryQueryError = ErrorType<ErrorResponse>
...
export function useGetCalendarSummary<TData = Awaited<ReturnType<typeof getCalendarSummary>>, TError = ErrorType<ErrorResponse>>(
